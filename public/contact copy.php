...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'sales@vortixenterprise.com';  // Replace with your professional email
    $mail->Password   = 'Vortix@0410';  // Replace with your email password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;  // Use ENCRYPTION_SMTPS for SSL
    $mail->Port       = 465;  // SMTP port for SSL (use 587 for TLS if needed)

    // Recipients
    $mail->setFrom('sales@vortixenterprise.com', 'Vortix Enterprise');
    $mail->addAddress('sales@vortixenterprise.com'); // Replace with the recipient's email
