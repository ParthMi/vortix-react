...
const Footer = () => {
  return (
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <NavLink
                  to="/"
                  className="mb-8 inline-block relative h-[50px] w-[200px]"
                >
                  {" "}
    ...
    <p>info.vortixenterprise@gmail.com</p>
    <p>sales@vortixenterprise.com</p>
</div>
                  </li>
                  <li className="flex items-center mb-4">
                    <span>
                    ...
                    <span className="text-base font-medium text-black dark:text-white">
                      Shop No.119, 4th Floor, Gruham Icon, Opp.Leck Garden,
                      Kosad, Surat, Gujarat-394107,India
                    </span>
                  </li>
                </ul>
              </div>
