  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg text-center  max-w-[600px]">
        ...
        <p className="text-gray-700 mb-6">We appreciate your business. If you have any questions, please email us at <a href="mailto:sales@vortixenterprise.com" className="text-blue-500">sales@vortixenterprise.com</a>.</p>
        <button
