              ...
              <div className="w-full px-4 lg:w-1/2 mt-4 md:mt-0">
                <div className="relative mx-auto aspect-[25/24] max-w-[300px] ">
                  <img
                    ...
                    alt="about-image"
                    fill
                    className="mx-auto max-w-full h-full rounded-md object-cover drop-shadow-three dark:hidden dark:drop-shadow-none lg:mr-0"
                  />
                  <img
                    src="/images/products/pellets-activated-carbon.jpg"
                    alt="about-image"
...
export default CoconutShellPelletsActivatedCarbon
